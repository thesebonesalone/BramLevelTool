...
draw_sprite_part_ext(global.tilemap,0,ds_grid_get(secrets,selected,1)*8,40,8,8,x+32,y+208,4,4,c_white,1)
draw_text(x+96,y+208,sec_arr[ds_grid_get(secrets,selected,1)])
draw_sprite_part_ext(global.tilemap,0,ds_grid_get(secrets,selected,2)*8,40,8,8,x+32,y+240,4,4,c_white,1)